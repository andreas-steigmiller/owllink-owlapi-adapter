...
import static org.semanticweb.owlapi.owllink.parser.PARSER_OWLXMLVocabulary.*;
 ...
 */
public class OWLXMLParserHandler extends DefaultHandler implements OWLAnonymousIndividualByIdProvider {


    private final OWLOntologyManager owlOntologyManager;
    private final OWLOntology ontology;
    protected final List<OWLElementHandler<?>> handlerStack;
    ...
    public void setPrefixName2PrefixMap(Map<String, String> prefixMap) {
        prefixName2PrefixMap.putAll(prefixMap);
    }
